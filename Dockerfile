...
# step 5 Copy our API script and exported ML model files into the containerco
COPY app.py .
...
# step 7 the execution command to launch our FastAPI app when the container starts
